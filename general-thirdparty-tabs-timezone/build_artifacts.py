...
<div class="card"><h3>上线与回滚</h3><p>前端 Tab 与时间展示可独立回滚；回滚不得改变后端 created_at 过滤口径。若新旧前端并存，接口仍接受 UTC ISO，并以 created_at 过滤。</p></div>
<div class="card"><h3>监控要点</h3><p>抽样核对页面筛选起止时间、请求 UTC ISO、created_at 过滤结果和导出时间；重点检查跨日边界与 8 小时偏差。</p></div>
<div class="card"><h3>相关文档</h3><table><tr><th>文档</th><th>链接 / 状态</th></tr><tr><td>MRD</td><td>暂未生成</td></tr><tr><td>需求说明</td><td><a href="__REQUIREMENT_URL__" target="_blank">需求说明 · 通用三方双 Tab 与时区统一</a></td></tr><tr><td>SDD</td><td><a href="__SDD_URL__" target="_blank">SDD · 通用三方双 Tab 与时区统一</a></td></tr><tr><td>高保真原型</td><td><a href="__PROTOTYPE_URL__" target="_blank">外网原型</a></td></tr></table></div>
</section>
<section id="changes" class="tab"><h3>行为变更</h3><table><tr><th>序号</th><th>位置（端 · 平台 · 页面）</th><th>优先级</th><th>变更内容</th><th>开发团队</th></tr>
<tr><td>1</td><td>运营后台 · 渠道投放 · 通用三方</td><td>P0 / P1</td><td><b>1-1 P0【新增】</b>双 Tab：电商平台默认、非电商平台独立展示。<br><b>1-2 P1【变更】</b>非电商 Tab 锁定平台，店铺 ID/名称改为渠道 ID/名称。<br><b>1-3 P1【变更】</b>查询按 Tab 隔离数据源，清空和切换不得串数据。</td><td></td></tr>
<tr><td>2</td><td>运营后台 · 渠道投放 · 通用三方列表</td><td>P0 / P1</td><td><b>2-1 P0【变更】</b>主时间列改为「订单创建时间」，展示 created_at。<br><b>2-2 P1【变更】</b>created_at 按 Asia/Shanghai 格式化；若保留 pay_time，列名必须为支付时间并同样转东八区。</td><td></td></tr>
<tr><td>3</td><td>前后端 · 通用三方 · 查询与导出</td><td>P1</td><td><b>3-1【变更】</b>前端将东八区起止时间转换为 UTC ISO；后端过滤 thirdpart_general_order.created_at。<br><b>3-2【变更】</b>导出按 created_at 过滤并按东八区输出时间，保留单平台与 90 天限制。</td><td></td></tr></table>
<h3>数据变更</h3><table><tr><th>对象</th><th>变更</th><th>用途</th><th>开发团队</th></tr><tr><td>thirdpart_general_order.created_at</td><td>作为查询过滤、列表主时间列与导出时间列的统一字段；展示格式为 Asia/Shanghai。</td><td>消除筛选字段与列表/导出字段错位。</td><td></td></tr><tr><td>pay_time</td><td>不再冒充订单创建时间；如保留，必须以「支付时间」列名并转为 Asia/Shanghai。</td><td>防止 UTC 墙钟值少 8 小时。</td><td></td></tr><tr><td>平台类型 / 渠道信息</td><td>前端按电商/非电商分区；非电商平台值固定，展示渠道 ID/名称。</td><td>承载已 ready 的非电商订单并与电商数据隔离。</td><td></td></tr></table>
