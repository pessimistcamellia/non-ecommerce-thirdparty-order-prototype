...
<tr><td>2</td><td>运营后台 · 渠道投放 · 通用三方列表</td><td>P0 / P1</td><td><b>2-1 P0【变更】</b>主时间列改为「订单创建时间」，展示 created_at。<br><b>2-2 P1【变更】</b>created_at 按 Asia/Shanghai 格式化；若保留 pay_time，列名必须为支付时间并同样转东八区。</td><td></td></tr></table>
